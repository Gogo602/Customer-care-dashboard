            ...
            <div className="flex items-center space-x-7 w-full">
                <div className="flex items-center justify-center space-x-10 w-full">
                    ...
                    <p className="hidden md:flex items-center justify-center">
                        <HiOutlineArrowPathRoundedSquare className="w-5 h-5 text-gray-500 mr-1 text-sm" />
                        Last updated 2 mins ago
                    </p>
                    <p className="hidden border border-gray-200 px-2 py-1 rounded-md md:flex items-center space-x-3">
                ...
                <div className="hidden lg:flex items-center justify-between w-2/3">
                    <button className="border border-gray-200 px-5 py-1 rounded-md">Break</button>
                    <button className="border border-red-500 text-red-500 bg-red-200 px-2 py-1 rounded-md">Clock out</button>
